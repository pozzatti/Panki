        			...
        			if (current!=null){
        				if (currents.size()>0){
                            ...
                            for (Card card : done){
                                ...
                                if (history.isLastFiveZero(cardName)){ card.setPriority(-3*increment); }
                                else if (history.isLastFourZero(cardName)){ card.setPriority(-2*increment); }
                                else if (history.isLastThreeZero(cardName)){ card.setPriority(-1*increment); }
                                else {
